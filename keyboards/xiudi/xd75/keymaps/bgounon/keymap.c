...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+-----------------|
     * | TAB    | A      | Z      | E      | R      | T      | ^      | ù      | *      | Y      | U      | I      | O      | P      | <      |
     * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+-----------------+--------|
     * | CAP LK | Q      | S      | D      | F      | G      | HOME   | DEL    | PG UP  | H      | J      | K      | L      | M      | ENTER  |
     * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------------------------+--------|
     * | LSHIFT | W      | X      | C      | V      | B      | END    | UP     | PG DN  | N      | ,      | ;      | :      | !      | RSHIFT |
     * |--------+--------+--------+--------+--------+-----------------+--------+--------+--------+--------+-----------------+--------+--------|
     * | LCTRL  | LGUI   | LALT   | FN     | SPACE  | SPACE  | LEFT   | DOWN   | RIGHT  | SPACE  | SPACE  | FN     | ALGR   | RGUI   | RCTRL  |
     * '--------------------------------------------------------------------------------------------------------------------------------------'
     */
    [_AZ] = LAYOUT_ortho_5x15( /* AZERTY */
        KC_ESC,  FR_AMPR,    FR_EACU,    FR_DQUO,    FR_QUOT,    FR_LPRN,    FR_RPRN, FR_EQL,  FR_DLR,  FR_MINS,    FR_EGRV,    FR_UNDS,    FR_CCED,    FR_AGRV,    KC_BSPC,
        KC_TAB,  FR_A,    FR_Z,    FR_E,    FR_R,    FR_T,    FR_CIRC, FR_UGRV, FR_ASTR, FR_Y,    FR_U,    FR_I,    FR_O,    FR_P,    FR_LABK,
        KC_CAPS, FR_Q,    FR_S,    FR_D,    FR_F,    FR_G,    KC_HOME, KC_DEL,  KC_PGUP, FR_H,    FR_J,    FR_K,    FR_L,    FR_M, KC_ENT,
        KC_LSFT, FR_W,    FR_X,    FR_C,    FR_V,    FR_B,    KC_END,  KC_UP,   KC_PGDN, FR_N,    FR_COMM,    FR_SCLN, FR_COLN,  FR_EXLM, KC_RSFT,
        KC_LCTL, KC_LGUI, KC_LALT, MO(_FN), KC_SPC,  KC_SPC,  KC_LEFT, KC_DOWN, KC_RGHT, KC_SPC,  KC_SPC,  MO(_FN), KC_ALGR, KC_RGUI, KC_RCTL
    ),
